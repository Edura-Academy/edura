...
function SekreterAyarlarContent() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-200 text-sm">Profil ve güvenlik ayarlarınızı yönetin</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="flex flex-col items-center mb-6">
                <div className="relative group">
                  {profilFoto ? (
                    ...
                    <div className="w-28 h-28 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-full flex items-center justify-center text-white text-3xl font-bold border-4 border-indigo-100">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 w-10 h-10 bg-indigo-600 text-white rounded-full flex items-center justify-center hover:bg-indigo-700 transition-colors shadow-lg disabled:opacity-50"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-slate-200 pt-4 mt-4">
                ...
                <div className="space-y-3">
                  {[
                    { key: 'odemeBildirim', label: 'Ödeme Bildirimleri' },
                    { key: 'kayitBildirim', label: 'Kayıt Bildirimleri' },
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 mt-6"
              >
...
export default function SekreterAyarlarPage() {
  return (
    <RoleGuard allowedRoles={['sekreter']}>
      <SekreterAyarlarContent />
    </RoleGuard>
  );
}
